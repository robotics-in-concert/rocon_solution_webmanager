...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{310DFAF0-77DD-E073-8DAB-ED125D49D16F}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|Win32'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\goodB2\.node-gyp\0.10.35\src;C:\Users\goodB2\.node-gyp\0.10.35\deps\uv\include;C:\Users\goodB2\.node-gyp\0.10.35\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\goodB2\.node-gyp\0.10.35\$(Configuration)\node.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <CustomBuild Include="C:\GTK\bin\libcairo-2.dll">
      ...
      <Command>call mkdir &quot;$(OutDir)&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;C:\GTK\bin\libcairo-2.dll&quot; &quot;$(OutDir)libcairo-2.dll&quot;</Command>
    ...
    <CustomBuild Include="C:\GTK\bin\libfontconfig-1.dll">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;$(OutDir)&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;C:\GTK\bin\libfontconfig-1.dll&quot; &quot;$(OutDir)libfontconfig-1.dll&quot;</Command>
    ...
    <CustomBuild Include="C:\GTK\bin\libexpat-1.dll">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;$(OutDir)&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;C:\GTK\bin\libexpat-1.dll&quot; &quot;$(OutDir)libexpat-1.dll&quot;</Command>
    ...
    <CustomBuild Include="C:\GTK\bin\libfreetype-6.dll">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;$(OutDir)&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;C:\GTK\bin\libfreetype-6.dll&quot; &quot;$(OutDir)libfreetype-6.dll&quot;</Command>
    ...
    <CustomBuild Include="C:\GTK\bin\libpng14-14.dll">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;$(OutDir)&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;C:\GTK\bin\libpng14-14.dll&quot; &quot;$(OutDir)libpng14-14.dll&quot;</Command>
    ...
    <CustomBuild Include="C:\GTK\bin\zlib1.dll">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;$(OutDir)&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;C:\GTK\bin\zlib1.dll&quot; &quot;$(OutDir)zlib1.dll&quot;</Command>
  ...
  <ItemGroup>
    <ProjectReference Include="canvas.vcxproj">
      <Project>{2A5DDD25-F246-CC0C-990D-A95E6683EBA6}</Project>
